(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("swiper/react", ["react"], factory);
	else if(typeof exports === 'object')
		exports["swiper/react"] = factory(require("react"));
	else
		root["swiper/react"] = factory(root["react"]);
...
__webpack_require__.d(__webpack_exports__, {
  Swiper: () => (/* reexport */ swiper_react_Swiper),
  SwiperSlide: () => (/* reexport */ SwiperSlide),
  useSwiper: () => (/* reexport */ useSwiper)
});
...
function useIsomorphicLayoutEffect(callback, deps) {
  // eslint-disable-next-line
  if (typeof window === 'undefined') return (0,external_react_.useEffect)(callback, deps);
...
const useSwiper = () => {
  return (0,external_react_.useContext)(SwiperContext);
};
...
;// CONCATENATED MODULE: ./src/SwiperToUmd.ts
